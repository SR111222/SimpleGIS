...
namespace SimpleGIS
{
    public partial class Form_PointRenderer : Form
    {
        #region 字段
        ...
        #region 构造函数
        public Form_PointRenderer(MyMapObjects.moMapLayer layer)
        {
            InitializeComponent();
            //填充样式下拉列表
        ...
        {
            mClassBreaksRendererMaxSize = (Double)nudClassBreaksMaxSize.Value;
        }
