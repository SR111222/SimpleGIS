...
{
    /// <summary>
    /// 绘图工具类型的封装，静态类，不能实例化(C#中的类前可以加static）*注：实现未完善，只有几种符号，小组作业还得自己实现
    /// </summary>
    internal static class moMapDrawingTools
    {
        ...
        /// </summary>
        /// <param name="g"></param>
        /// <param name="extent">外包矩形</param>
        /// <param name="mapScale">地图尺度大小</param>
        /// <param name="dpm"></param>
        /// <param name="mpu">单位是多少米</param>
        /// <param name="geometry">要绘制的几何图形</param>
