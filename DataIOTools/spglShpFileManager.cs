...
namespace SimpleGIS.DataIOTools
{
    ...
    public class spglShpFileManager
    {
        ...
        public spglShpFileManager(string filePath)
        {
        ...
        public spglShpFileManager(MyMapObjects.moGeometryTypeConstant GeometryType)
        {
            _FileCode = 9995;
            _Version = 1000;
